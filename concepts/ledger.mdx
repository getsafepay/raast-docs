...
<Callout type="info">Raast payments settle in scheduled batches. The `running_balance` reflects the unsettled delta since the last settle and resets to `0` when a settlement batch is scheduled.</Callout>
